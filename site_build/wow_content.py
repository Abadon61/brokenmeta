...
UI = {
    "fr": {"sources": "Sources", "sources_note": "Informations vérifiées le 20 septembre 2026. Les points qui ne viennent que d'un wiki communautaire ou d'une seule source sont signalés dans le texte.",
           ...
           "share_hook": "Aide-nous à améliorer la précision de nos données en partageant les tiennes !",
           "share_sub": "Notre addon gratuit BrokenMeta affiche la valeur en DPS de chaque objet, repère tes améliorations et relève les vraies valeurs de WoW: Forever et les prix de l'hôtel des ventes. Envoi anonyme, en deux clics.",
           "share_cta": "Partager mes données",
           "addon_cta": "Télécharger l'addon {v}",
    ...
    "en": {"sources": "Sources", "sources_note": "Information checked on September 20, 2026. Points that only come from a community wiki or a single source are flagged in the text.",
           ...
           "share_hook": "Help us make our data more accurate by sharing yours!",
           "share_sub": "Our free BrokenMeta addon shows every item's DPS value, spots your upgrades and records WoW: Forever's real values and auction house prices. Anonymous, sent in two clicks.",
           "share_cta": "Share my data",
           "addon_cta": "Download the addon {v}",
