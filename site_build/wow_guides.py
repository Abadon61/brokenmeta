...
_MYSIM = {
    "fr": {
        ...
        "ms_js": {
            ...
            "pw_addon_p": "Copiez ce texte, puis dans l'addon : onglet Personnage > « Importer mes poids » (ou /bmw import), collez et validez. L'addon utilisera vos poids, justes à votre niveau, au lieu des poids génériques niveau 20.",
    ...
    "en": {
        ...
        "ms_js": {
            ...
            "pw_addon_p": "Copy this text, then in the addon: Character tab > 'Import my weights' (or /bmw import), paste and confirm. The addon will use your weights, right for your level, instead of the generic level-20 ones.",
