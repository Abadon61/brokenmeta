...
TXT = {
    "fr": {
        ...
        "note_with_rotation": "Les données de talents viennent du client bêta. La rotation ci-dessus est notre propre reconstruction, sourcée sort par sort depuis le guide Icy Veins et vérifiée contre l'infobulle Wowhead réelle de chaque sort — pas fournie telle quelle par une source unique. Elle sera affinée à mesure que la bêta avance.",
        "rotation_h2": "Rotation niveau 20", "rotation_p": "L'ordre de priorité utilisé pour calculer le DPS simulé de cette spécialisation, sourcé sort par sort depuis le guide Icy Veins. Survolez un sort pour voir son infobulle Wowhead réelle.",
        "rotation_step_word": "Étape",
        "kind_labels": {
            "builder": "Génère de la ressource (rage/énergie/points de combo)",
            "finisher_damage": "À utiliser à ressource maximale (dégâts)",
            "finisher_dot": "À utiliser à ressource maximale (DoT)",
            "finisher_buff": "À utiliser à ressource maximale (buff)",
            "maintain_dot": "À maintenir en permanence sur la cible",
            "maintain_buff": "À maintenir en permanence",
            "dodge_proc": "Dès que la cible esquive une attaque",
            "on_cooldown": "Dès que disponible",
            "filler": "Sort de base, à répéter",
            "once": "Une seule fois, en ouverture",
            "judgement_release": "Libère le Sceau actif sur la cible",
            "swing_enhancer": "Améliore la prochaine attaque",
        },
        ...
        "gear_h2": "Équipement niveau 20 (BiS)", "gear_p": "Aucune source ne publie encore de liste d'équipement (BiS) ni d'enchantements pour cette spécialisation : les guides Icy Veins de Forever se limitent pour l'instant au niveau 20 et ne les détaillent pas. Les pages de donjons permettent de parcourir le butin par type d'objet et par stats, sans classement par spécialisation : c'est à vous de choisir ce qui compte pour votre classe.",
        "gear_bis_p": "Notre propre optimiseur : pour chaque emplacement, le vrai butin de donjon (niveau 20 ou moins) le mieux noté par notre moteur de simulation, en respectant les vraies restrictions d'armure/d'arme de la classe. Les enchantements ne sont pas encore pris en compte.",
        "gear_bis_fallback_source": "Choix ForeverChanges.pro (aucun butin de donjon sourcé à ce niveau)",
        "gear_bis_stats_h3": "Statistiques obtenues avec ce stuff",
        "gear_bis_dps": "DPS simulé avec cet équipement précis : {dps}.",
        "gear_bis_methodology": "Calculé avec le même moteur que le classement DPS, à partir du vrai butin de donjon WoW: Forever (donjons uniquement — les raids commencent à exiger le niveau 60) plutôt que la liste externe ForeverChanges.pro. Les stats de base du personnage (avant équipement) utilisées ici sont des stats de NIVEAU 1 sourcées (RankedBoost), faute de table de niveau 20 indépendante : le DPS ci-dessus est donc probablement légèrement sous-estimé par rapport à un vrai personnage niveau 20.",
        "slot_labels": {"head": "Tête", "neck": "Cou", "shoulder": "Épaule", "back": "Dos", "chest": "Torse", "wrist": "Poignets", "hands": "Mains", "waist": "Taille", "legs": "Jambes", "feet": "Pieds", "finger": "Doigt", "finger2": "Doigt", "trinket": "Bijou", "trinket2": "Bijou", "main_hand": "Main droite", "off_hand": "Main gauche", "ranged": "À distance"},
        ...
        "dg_kicker": "World of Warcraft: Forever · Donjons", "dg_levels": "Niveaux", "dg_items_n": "objets", "dg_title": ["Table de butin {name} WoW: Forever ({n} objets)", "Butin {name} WoW: Forever ({n} objets)", "Butin {name} WoW: Forever"], "dg_desc": ["Table de butin de {name}{abbr} dans WoW: Forever : les {n} objets avec leurs stats réelles et le boss qui les lâche ({bosses}). Filtres par emplacement et stats.", "Table de butin de {name}{abbr} dans WoW: Forever : les {n} objets avec leurs stats réelles et leur boss. Filtres par emplacement et stats.", "Butin de {name} dans WoW: Forever : {n} objets avec leurs stats et leur boss."],
        "dg_h1": "Table de butin : {name}", "dg_intro": "Les objets équipables de {name} ({levels}), avec leurs stats réelles dans Forever. Filtrez par type d'objet, stat principale et stats secondaires.", "dg_intro_nolvl": "Les objets équipables de {name}, avec leurs stats réelles dans Forever. Filtrez par type d'objet, stat principale et stats secondaires.",
        ...
        "op_kicker": "World of Warcraft: Forever · Item builder", "op_title": "Item builder WoW: Forever", "op_desc": "Choisissez votre type d'armure et vos stats, puis retrouvez les meilleurs objets par emplacement parmi les donjons et raids de WoW: Forever.",
        "op_h1": "Item builder", "op_intro": "Cliquez un emplacement d'équipement pour choisir un objet parmi ceux des donjons et raids catalogués, filtrable par type et par stats. Construisez votre équipement complet et suivez le total de vos stats, sans classement caché par spécialisation.",
    ...
    "en": {
        ...
        "note_with_rotation": "Talent data comes from the beta client. The rotation above is our own reconstruction, sourced ability by ability from the Icy Veins guide and cross-checked against each spell's real Wowhead tooltip -- not handed to us as-is by a single source. It will be refined as the beta progresses.",
        "rotation_h2": "Level 20 rotation", "rotation_p": "The priority order used to compute this specialization's simulated DPS, sourced ability by ability from the Icy Veins guide. Hover a spell to see its real Wowhead tooltip.",
        "rotation_step_word": "Step",
        "kind_labels": {
            "builder": "Builds resource (rage/energy/combo points)",
            "finisher_damage": "Use at max resource (damage)",
            "finisher_dot": "Use at max resource (DoT)",
            "finisher_buff": "Use at max resource (buff)",
            "maintain_dot": "Keep active on the target at all times",
            "maintain_buff": "Keep active at all times",
            "dodge_proc": "As soon as the target dodges an attack",
            "on_cooldown": "On cooldown",
            "filler": "Base filler spell",
            "once": "Once, as an opener",
            "judgement_release": "Releases the active Seal on the target",
            "swing_enhancer": "Enhances the next attack",
        },
        ...
        "gear_h2": "Level 20 gear (BiS)", "gear_p": "No source publishes a best-in-slot list or enchants for this specialization yet: the Icy Veins Forever guides only cover level 20 for now and do not detail them. The dungeon pages let you browse loot by item type and stats, with no per-specialization ranking: it's up to you to pick what matters for your class.",
        "gear_bis_p": "Our own optimizer: for each slot, the real dungeon loot (level 20 or under) our simulation engine ranks highest, respecting the class's real armor/weapon restrictions. Enchants aren't factored in yet.",
        "gear_bis_fallback_source": "ForeverChanges.pro pick (no dungeon loot sourced at this level)",
        "gear_bis_stats_h3": "Stats with this gear",
        "gear_bis_dps": "Simulated DPS with this exact gear: {dps}.",
        "gear_bis_methodology": "Computed with the same engine as the DPS ranking, from real WoW: Forever dungeon loot (dungeons only -- raids all require level 60) instead of the external ForeverChanges.pro list. The character's base (no-gear) stats used here are sourced LEVEL 1 stats (RankedBoost), for lack of an independent level 20 table, so the DPS above is likely a slight under-count versus a real level 20 character.",
        "slot_labels": {"head": "Head", "neck": "Neck", "shoulder": "Shoulder", "back": "Back", "chest": "Chest", "wrist": "Wrist", "hands": "Hands", "waist": "Waist", "legs": "Legs", "feet": "Feet", "finger": "Finger", "finger2": "Finger", "trinket": "Trinket", "trinket2": "Trinket", "main_hand": "Main Hand", "off_hand": "Off Hand", "ranged": "Ranged"},
        ...
        "dg_kicker": "World of Warcraft: Forever · Dungeons", "dg_levels": "Levels", "dg_items_n": "items", "dg_title": ["{name} Loot Table - WoW: Forever ({n} items)", "{name} Loot - WoW: Forever ({n} items)", "{name} Loot - WoW: Forever"], "dg_desc": ["{name}{abbr} loot table for WoW: Forever: all {n} drops with their real stats and the boss that drops them ({bosses}). Filter by slot and stats.", "{name}{abbr} loot table for WoW: Forever: all {n} drops with their real stats and which boss drops them. Filter by slot and stats.", "{name} loot in WoW: Forever: {n} items with their stats and boss."],
        "dg_h1": "{name} loot table", "dg_intro": "The equippable items of {name} ({levels}), with their real stats in Forever. Filter by item type, primary stat and secondary stats.", "dg_intro_nolvl": "The equippable items of {name}, with their real stats in Forever. Filter by item type, primary stat and secondary stats.",
        ...
        "op_kicker": "World of Warcraft: Forever · Item builder", "op_title": "WoW: Forever Item builder", "op_desc": "Pick your armor type and stats, then find the best items per slot across every WoW: Forever dungeon and raid.",
        "op_h1": "Item builder", "op_intro": "Click a gear slot to pick an item from every catalogued dungeon and raid, filterable by type and stats. Build out your full loadout and track your total stats, with no hidden per-specialization ranking.",
...
# "Simulate my character" page (/wow-forever/simuler-mon-personnage/): paste the BrokenMeta
# addon's export, simulate it in the browser with wow_dps_sim.py (see wow_mysim.py).
_MYSIM = {
    "fr": {
        "ms_kicker": "World of Warcraft: Forever · Simuler mon personnage",
        "ms_title": "Simuler mon personnage WoW: Forever (DPS)",
        "ms_desc": "Collez l'export de l'addon BrokenMeta et simulez le DPS de votre vrai personnage WoW: Forever, comparé au meilleur équipement niveau 20.",
        "ms_h1": "Simuler mon personnage",
        "ms_intro": "Collez l'export de l'addon BrokenMeta : la page simule le DPS de votre personnage avec ses vraies stats et ses armes, puis le compare au meilleur équipement (BiS) niveau 20 de sa spécialisation. Même moteur que notre classement DPS.",
        ...
        "ms_limits": [
            "Les sorts sont simulés au rang correspondant à votre niveau (tables du client bêta), mais les rotations sont celles du niveau 20 : les capacités apprises plus tard n'y sont pas encore.",
            "L'export contient tous vos talents, mais le simulateur n'applique que les quelques talents dont l'effet chiffré est sourcé.",
            "Pas de régénération ni de pénurie de mana, pas de baguette, pas de familier de Démoniste : les mêmes limites que notre classement DPS.",
            "Les stats viennent de la feuille de personnage au moment de l'export : un buff actif les fausse.",
        ],
        "ms_js": {
            "st_engine": "Chargement du moteur de simulation (premier lancement : quelques secondes)…",
            "st_files": "Chargement des données des sorts…",
            "st_sim": "Simulation en cours…",
            "st_crash": "La simulation a échoué. Rechargez la page et réessayez.",
            "st_err_empty": "Collez d'abord l'export de l'addon.",
            "st_err_bad_format": "Ce texte n'est pas un export BrokenMeta (il doit commencer par format=BMW1). Utilisez /bmw export en jeu.",
            "st_err_no_class": "L'export ne contient pas de classe.",
            "st_err_class_not_simulated": "Aucune spécialisation DPS de cette classe n'est encore simulée.",
            "tank": "tank", "level": "Niveau",
            "you": "Votre personnage", "bis": "Meilleur équipement (BiS) niv. 20",
            "diff_up": "{pct} % au-dessus du BiS simulé.", "diff_down": "{pct} % en dessous du BiS simulé.",
            "breakdown_h2": "D'où vient votre DPS", "total": "Total",
            "stats_h2": "Stats utilisées par la simulation",
            "stat_ap": "Puissance d'attaque", "stat_sp": "Puissance des sorts", "stat_crit": "Coup critique",
            "stat_hit": "Chance de toucher", "stat_mh": "Arme main droite (dégâts · vitesse)", "stat_oh": "Arme main gauche (dégâts · vitesse)",
            "warn_level": "Votre personnage n'est pas niveau 20 : ses sorts sont simulés au bon rang pour son niveau (données du client), mais les capacités apprises après le niveau 20 ne sont pas encore dans les rotations (aucune rotation sourcée n'existe au-delà du plafond de la bêta), et la comparaison avec le BiS niveau 20 est masquée.",
            "warn_buffs": "Des buffs étaient actifs au moment de l'export : ils gonflent vos stats. Pour un résultat juste, exportez sans buff.",
            "warn_no_weapon_data": "L'export ne contient pas les dégâts de vos armes (addon antérieur à la 0.3) : l'arme du BiS a été utilisée à la place. Mettez l'addon à jour.",
            "update": "Une nouvelle version de l'addon est disponible ({old} → {new}) :",
            "method_note": "{n} combats simulés de {s} secondes contre une cible, avec les mêmes tirages aléatoires pour votre personnage et le BiS : l'écart vient uniquement des stats et des armes.",
            "pw_btn": "Calculer mes poids de stats et mon Top gear",
            "pw_addon_h": "Utiliser ces poids dans l'addon",
            "pw_addon_p": "Copiez ce texte, puis dans l'addon : onglet Personnage > « Importer mes poids » (ou /bmw import), collez et validez. L'addon utilisera vos poids, justes à votre niveau, au lieu des poids génériques niveau 20. À refaire tous les 5 niveaux : vos stats et vos rangs de sorts évoluent (l'addon vous le rappellera).",
            "pw_copy": "Copier pour l'addon", "pw_copied": "Copié !",
            "st_personal": "Calcul de vos poids de stats… {d} / {t}",
            "pw_h2": "Vos poids de stats",
            "pw_intro": "Ce que rapporte un point de chaque stat, calculé sur votre propre fiche de personnage et vos armes (et non sur un équipement type). La dernière colonne exprime chaque stat en « équivalent {ref} ».",
            "pw_stat": "Stat", "pw_dps": "DPS par point", "pw_norm": "Équivalent {ref}",
            "w_str": "Force", "w_agi": "Agilité", "w_int": "Intelligence", "w_ap": "Puissance d'attaque", "w_sp": "Puissance des sorts",
            "w_crit": "Coup critique (1 %)", "w_hit": "Toucher (1 %)", "w_wdps_mh": "DPS de l'arme (main droite)",
            "w_wdps_oh": "DPS de l'arme (main gauche)", "w_wdps_r": "DPS de l'arme à distance",
            "tg_h2": "Top gear : les meilleurs objets de donjon pour vous",
            "tg_intro": "Chaque objet de donjon que votre classe peut porter à votre niveau (ou dans 3 niveaux), valorisé avec vos poids de stats et comparé à ce que vous portez. Les 3 meilleurs par emplacement.",
            "tg_no_worn": "Votre export ne contient pas les stats de votre équipement porté (addon antérieur à la 0.6.1) : le gain est calculé comme si l'emplacement était vide. Mettez l'addon à jour pour une comparaison juste.",
            "tg_none": "Aucun objet de donjon ne ferait mieux que votre équipement actuel.",
            "tg_item": "Objet", "tg_slot": "Emplacement", "tg_where": "Où l'obtenir", "tg_gain": "Gain (DPS)",
            "tg_req": "niveau {n} requis", "tg_quest": "Récompense de quête",
            "pw_method": "Poids calculés par différences centrées sur {n} combats simulés de {s} secondes, avec les mêmes tirages aléatoires à chaque essai. Le toucher et le critique restent les plus incertains (environ ±10 %).",
        },
    },
    "en": {
        "ms_kicker": "World of Warcraft: Forever · Simulate my character",
        "ms_title": "Simulate my WoW: Forever character (DPS)",
        "ms_desc": "Paste the BrokenMeta addon export and simulate your real WoW: Forever character's DPS, compared with the best level-20 gear.",
        "ms_h1": "Simulate my character",
        ...
        "ms_limits": [
            "Spells are simulated at the rank matching your level (beta client tables), but rotations are the level-20 ones: abilities learned later aren't in them yet.",
            "The export carries all your talents, but the simulator only applies the few talents whose numeric effect is sourced.",
            "No mana regeneration or shortage, no wand, no Warlock pet: the same limits as our DPS ranking.",
            "Stats come from the character sheet at export time: an active buff skews them.",
        ],
        "ms_js": {
            "st_engine": "Loading the simulation engine (first run: a few seconds)…",
            "st_files": "Loading spell data…",
            "st_sim": "Simulating…",
            "st_crash": "The simulation failed. Reload the page and try again.",
            "st_err_empty": "Paste the addon export first.",
            "st_err_bad_format": "This isn't a BrokenMeta export (it must start with format=BMW1). Use /bmw export in game.",
            "st_err_no_class": "The export has no class.",
            "st_err_class_not_simulated": "No DPS spec of this class is simulated yet.",
            "tank": "tank", "level": "Level",
            "you": "Your character", "bis": "Best-in-slot (BiS) lvl 20",
            "diff_up": "{pct}% above the simulated BiS.", "diff_down": "{pct}% below the simulated BiS.",
            "breakdown_h2": "Where your DPS comes from", "total": "Total",
            "stats_h2": "Stats used by the simulation",
            "stat_ap": "Attack power", "stat_sp": "Spell power", "stat_crit": "Critical strike",
            "stat_hit": "Hit chance", "stat_mh": "Main-hand weapon (damage · speed)", "stat_oh": "Off-hand weapon (damage · speed)",
            "warn_level": "Your character isn't level 20: its spells are simulated at the right rank for its level (client data), but abilities learned after level 20 are not in the rotations yet (no sourced rotation exists above the beta's cap), and the level-20 BiS comparison is hidden.",
            "warn_buffs": "Buffs were active at export time: they inflate your stats. For an accurate result, export without buffs.",
            "warn_no_weapon_data": "The export has no weapon damage (addon older than 0.3): the BiS weapon was used instead. Update the addon.",
            "update": "A newer version of the addon is available ({old} → {new}):",
            "method_note": "{n} simulated {s}-second single-target fights, with the same random rolls for your character and the BiS: the gap comes only from stats and weapons.",
            "pw_btn": "Compute my stat weights and Top gear",
            "pw_addon_h": "Use these weights in the addon",
            "pw_addon_p": "Copy this text, then in the addon: Character tab > 'Import my weights' (or /bmw import), paste and confirm. The addon will use your weights, right for your level, instead of the generic level-20 ones. Redo it every 5 levels: your stats and spell ranks change (the addon will remind you).",
            "pw_copy": "Copy for the addon", "pw_copied": "Copied!",
            "st_personal": "Computing your stat weights… {d} / {t}",
            "pw_h2": "Your stat weights",
            "pw_intro": "What one point of each stat is worth, computed on your own character sheet and weapons (not a template gear set). The last column expresses each stat as \"{ref} equivalent\".",
            "pw_stat": "Stat", "pw_dps": "DPS per point", "pw_norm": "{ref} equivalent",
            "w_str": "Strength", "w_agi": "Agility", "w_int": "Intellect", "w_ap": "Attack power", "w_sp": "Spell power",
            "w_crit": "Critical strike (1%)", "w_hit": "Hit (1%)", "w_wdps_mh": "Weapon DPS (main hand)",
            "w_wdps_oh": "Weapon DPS (off hand)", "w_wdps_r": "Ranged weapon DPS",
            "tg_h2": "Top gear: the best dungeon items for you",
            "tg_intro": "Every dungeon item your class can wear at your level (or within 3 levels), valued with your stat weights and compared with what you wear. The best 3 per slot.",
            "tg_no_worn": "Your export has no stats for your equipped gear (addon older than 0.6.1): the gain is computed as if the slot were empty. Update the addon for a fair comparison.",
            "tg_none": "No dungeon item would beat your current gear.",
            "tg_item": "Item", "tg_slot": "Slot", "tg_where": "Where to get it", "tg_gain": "Gain (DPS)",
            "tg_req": "requires level {n}", "tg_quest": "Quest reward",
            "pw_method": "Weights computed by central differences over {n} simulated {s}-second fights, with the same random rolls on every try. Hit and crit remain the most uncertain (about ±10%).",
        },
    },
}
for _lang, _txt in _MYSIM.items():
    TXT[_lang].update(_txt)


# "Share my data" page (/wow-forever/partager-mes-donnees/): upload the addon's SavedVariables
# file to wow-worker, with consent and a deletion code (see js/wow-share.js, wow-worker/).
_SHARE = {
    "fr": {
        "sh_kicker": "World of Warcraft: Forever · Partager mes données",
        "sh_title": "Partager les données de l'addon BrokenMeta",
        "sh_desc": "Envoyez anonymement les mesures et les prix d'hôtel des ventes relevés par l'addon BrokenMeta pour améliorer le simulateur et les guides WoW: Forever.",
        "sh_h1": "Partager mes données",
        "sh_intro": "L'addon BrokenMeta relève en jeu ce que les sites ne peuvent pas obtenir autrement : les vraies valeurs de WoW: Forever et les prix de l'hôtel des ventes. En les partageant, vous aidez à corriger le simulateur et à remettre des prix dans les guides de métiers. C'est facultatif et anonyme.",
        "sh_why_h2": "À quoi servent ces données",
        "sh_why": [
            "Mesures de la feuille de personnage (critique, régénération de mana, esquive…) : remplacer les valeurs encore approximatives du simulateur DPS par les vraies valeurs du jeu.",
            "Stats des familiers : calculer la vraie part de puissance d'attaque que le Chasseur transmet à son familier.",
            "Conversion des cotes (critique, toucher, hâte) par niveau : pondérer correctement les objets.",
            "Prix de l'hôtel des ventes : afficher le coût réel des guides de métiers, par royaume et faction.",
        ],
        "sh_steps": [
            "En jeu, activez le partage : <code>/bmw share on</code> (ou onglet Data du hub).",
            "Le plus simple : onglet Data du hub > « Copier pour le site », Ctrl+C, puis collez le texte ci-dessous. Sinon, après un <code>/reload</code>, déposez le fichier <code>BrokenMetaWeights.lua</code> de <code>World of Warcraft\\_classic_beta_\\WTF\\Account\\&lt;votre compte&gt;\\SavedVariables\\</code>.",
            "Vérifiez l'aperçu, cochez la case de consentement et envoyez.",
        ],
        "sh_drop": "Glissez BrokenMetaWeights.lua ici, ou cliquez pour le choisir",
        "sh_paste_label": "… ou collez le texte de l'addon (onglet Data du hub > « Copier pour le site », puis Ctrl+C)",
        "sh_consent": "J'accepte que ces données anonymes (mesures en jeu et prix, royaume et faction compris) soient enregistrées par BrokenMeta.gg pour les usages décrits ci-dessus, conformément à la <a href=\"../../confidentialite/#addon-wow\">politique de confidentialité</a>.",
        "sh_send": "Envoyer à BrokenMeta",
        "sh_delete_h2": "Supprimer des données envoyées",
        "sh_delete_p": "Chaque envoi donne un code de suppression. Collez-le ici pour effacer définitivement cet envoi de nos serveurs.",
        "sh_delete_btn": "Supprimer",
        "sh_privacy": "Le fichier est lu dans votre navigateur : seules les mesures et les prix partent, jamais les noms de vos personnages ni vos réglages. Votre adresse IP n'est pas conservée. Détails : <a href=\"../../confidentialite/#addon-wow\">politique de confidentialité</a>.",
        "sh_js": {
            "err_file": "Ce fichier n'a pas pu être lu. Choisissez bien BrokenMetaWeights.lua (dans SavedVariables).",
            "err_nodata": "Ce fichier ne contient encore aucune mesure ni aucun scan. Jouez un peu avec l'addon 0.5 ou plus, puis /reload.",
            "err_network": "Envoi impossible (réseau). Réessayez dans un instant.",
            "err_server": "Le serveur a refusé l'envoi. Réessayez plus tard.",
            "err_rate_limited": "Trop d'envois depuis votre connexion : réessayez dans une heure.",
            "err_empty": "Aucune donnée valide dans ce fichier.",
            "err_too_large": "Fichier trop volumineux.",
            "sending": "Envoi…",
            "preview_h2": "Ce qui sera envoyé",
            "p_meas": "{n} mesures", "kind_stats": "feuille de personnage", "kind_pet": "familier", "kind_rating": "conversion des cotes",
            "p_ah": "{n} scan(s) de l'hôtel des ventes, {p} prix", "items": "objets",
            "p_not_sent": "Non envoyé : les noms de personnages ({n} dans le fichier) et vos réglages.",
            "p_version": "Addon {v}, client {c}",
            "share_off": "Le partage est désactivé dans l'addon. Tapez /bmw share on en jeu, puis /reload, et redéposez le fichier.",
            "sent": "Merci ! {m} mesures et {p} prix envoyés.",
            "code_intro": "Votre code de suppression (gardez-le si vous voulez effacer cet envoi plus tard) :",
            "del_bad": "Code invalide (32 caractères).",
            "del_ok": "Envoi supprimé.",
            "del_notfound": "Aucun envoi ne correspond à ce code.",
        },
        "priv_addon_h2": "Addon World of Warcraft BrokenMeta et partage de données",
    },
    "en": {
        "sh_kicker": "World of Warcraft: Forever · Share my data",
        "sh_title": "Share your BrokenMeta addon data",
        "sh_desc": "Anonymously send the measurements and auction prices recorded by the BrokenMeta addon to improve the WoW: Forever simulator and guides.",
        "sh_h1": "Share my data",
        "sh_intro": "The BrokenMeta addon records in game what sites can't get any other way: WoW: Forever's real values and auction house prices. Sharing them helps fix the simulator and put prices back in the profession guides. It's optional and anonymous.",
        "sh_why_h2": "What this data is used for",
        "sh_why": [
            "Character sheet measurements (crit, mana regen, dodge…): replace the DPS simulator's remaining approximations with the game's real values.",
            "Pet stats: work out the real share of attack power a Hunter passes to their pet.",
            "Rating conversion (crit, hit, haste) per level: weigh items correctly.",
            "Auction house prices: show the real cost of profession guides, per realm and faction.",
        ],
        "sh_steps": [
            "In game, turn sharing on: <code>/bmw share on</code> (or the hub's Data tab).",
            "Easiest: hub Data tab > \"Copy for the site\", Ctrl+C, then paste the text below. Otherwise, after a <code>/reload</code>, drop the <code>BrokenMetaWeights.lua</code> file from <code>World of Warcraft\\_classic_beta_\\WTF\\Account\\&lt;your account&gt;\\SavedVariables\\</code>.",
            "Check the preview, tick the consent box and send.",
        ],
        "sh_drop": "Drop BrokenMetaWeights.lua here, or click to choose it",
        "sh_paste_label": "… or paste the addon text (hub Data tab > \"Copy for the site\", then Ctrl+C)",
        "sh_consent": "I agree that this anonymous data (in-game measurements and prices, including realm and faction) is stored by BrokenMeta.gg for the uses described above, under the <a href=\"../../confidentialite/#addon-wow\">privacy policy</a>.",
        "sh_send": "Send to BrokenMeta",
        "sh_delete_h2": "Delete data you sent",
        "sh_delete_p": "Every upload gives a deletion code. Paste it here to permanently erase that upload from our servers.",
        "sh_delete_btn": "Delete",
        "sh_privacy": "The file is read in your browser: only measurements and prices are sent, never your character names or settings. Your IP address is not kept. Details: <a href=\"../../confidentialite/#addon-wow\">privacy policy</a>.",
        "sh_js": {
            "err_file": "This file couldn't be read. Make sure you pick BrokenMetaWeights.lua (in SavedVariables).",
            "err_nodata": "This file has no measurement or scan yet. Play a bit with addon 0.5 or later, then /reload.",
            "err_network": "Couldn't send (network). Try again in a moment.",
            "err_server": "The server refused the upload. Try again later.",
            "err_rate_limited": "Too many uploads from your connection: try again in an hour.",
            "err_empty": "No valid data in this file.",
            "err_too_large": "File too large.",
            "sending": "Sending…",
            "preview_h2": "What will be sent",
            "p_meas": "{n} measurements", "kind_stats": "character sheet", "kind_pet": "pet", "kind_rating": "rating conversion",
            "p_ah": "{n} auction house scan(s), {p} prices", "items": "items",
            "p_not_sent": "Not sent: character names ({n} in the file) and your settings.",
            "p_version": "Addon {v}, client {c}",
            "share_off": "Sharing is off in the addon. Type /bmw share on in game, then /reload, and drop the file again.",
            "sent": "Thank you! {m} measurements and {p} prices sent.",
            "code_intro": "Your deletion code (keep it if you want to erase this upload later):",
            "del_bad": "Invalid code (32 characters).",
            "del_ok": "Upload deleted.",
            "del_notfound": "No upload matches this code.",
        },
        "priv_addon_h2": "BrokenMeta World of Warcraft addon and data sharing",
    },
}
