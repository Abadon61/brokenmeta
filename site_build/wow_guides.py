...
_MYSIM = {
    ...
    "en": {
        ...
        "ms_privacy": "The simulation runs entirely in your browser: the export is never sent to any server. It contains no character name and no realm. The first run downloads the Python engine (about 11 MB); later runs are instant.",
