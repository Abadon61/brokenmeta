...
TXT = {
    "fr": {
        ...
        "p_intro": "Le parcours ci-dessous passe de 1 à {cap} en au moins {crafts} créations, pour environ {total} au minimum. Il est calculé à partir des recettes, des composants et des prix de la base de données Wowhead Forever et des tables du client bêta. {risk}",
        ...
        "s_risky": "Points non garantis", "s_unknown": "Plans à trouver (prix inconnu)", "rank_quest": "Quête ou livre (prix non indiqué)",
        ...
        "how_h2": "Comment ce parcours est calculé", "how": [
            ...
            "Un composant vendu par un vendeur est compté à son prix d'achat. Un composant à récolter, à fabriquer ou à obtenir autrement est compté à sa valeur de revente au vendeur : la bêta n'a pas encore de prix à l'hôtel des ventes, c'est donc un plancher, pas un prix de marché.",
        ...
        "limit_disenchant": "Les matériaux d'enchantement (poussières, essences, éclats) viennent du désenchantement d'objets : leur valeur de revente dans les tables est symbolique, donc leur coût réel n'est pas mesuré ici.",
    ...
    "en": {
        ...
        "p_intro": "The route below goes from 1 to {cap} in at least {crafts} crafts, for about {total} at minimum. It is computed from the recipes, reagents and prices of the Wowhead Forever database and the beta client tables. {risk}",
        ...
        "s_risky": "Non-guaranteed points", "s_unknown": "Plans to find (unknown price)", "rank_quest": "Quest or book (price not listed)",
        ...
        "how_h2": "How this route is computed", "how": [
            ...
            "A reagent sold by a vendor is counted at its purchase price. A reagent you gather, craft or obtain otherwise is counted at its vendor resale value: the beta has no auction house prices yet, so this is a floor, not a market price.",
        ...
        "limit_disenchant": "Enchanting materials (dusts, essences, shards) come from disenchanting items: their vendor value in the tables is a token amount, so their real cost is not measured here.",
