...
TXT = {
    "fr": {
        ...
        "gear_bis_p": "L'équipement utilisé pour calculer le DPS simulé de cette spécialisation dans le classement de la page d'accueil. Les enchantements ne sont pas encore pris en compte.",
        "gear_bis_note": "Détail complet par emplacement (options alternatives, sources de drop, quêtes) sur",
    ...
    "en": {
        ...
        "gear_bis_p": "The gear used to compute this specialization's simulated DPS in the homepage ranking. Item names are shown in French (the source site is French-only); enchants aren't factored in yet.",
        "gear_bis_note": "Full detail per slot (alternate picks, drop sources, quest chains) on",
