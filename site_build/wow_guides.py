...
TXT = {
    "fr": {
        ...
        "tc_method": [
            ...
            "Le poids des stats de notation (Cote de critique, de hâte, de toucher) n'est pas encore affiché : leur taux de conversion en pourcentage n'est pas confirmé pour WoW: Forever dans les données publiques actuellement disponibles.",
    ...
    "en": {
        ...
        "tc_method": [
            ...
            "Rating-based stats (Critical Strike Rating, Haste Rating, Hit Rating) don't have a weight shown yet: their percentage conversion rate isn't confirmed for WoW: Forever in the public data currently available.",
